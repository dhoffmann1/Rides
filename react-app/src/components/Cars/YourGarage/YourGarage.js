                ...
                <div id="your-garage-car-container" key={car.id}>
                  <div id="your-garage-car-main-container">
                    <div id="your-garage-car-image-container">
                      {car?.images?.length === 0 && <img id="your-garage-car-image" src='https://ridesappbucket.s3.amazonaws.com/awaiting_car.png' alt={`car ${car.id}`} onError={e => { e.currentTarget.src = 'https://ridesappbucket.s3.amazonaws.com/select_car.png'; }} />}
                      {car?.images?.length > 0 && <img id="your-garage-car-image" src={car?.images[0]?.imageUrl} alt={`car ${car.id}`} onError={e => { e.currentTarget.src = 'https://ridesappbucket.s3.amazonaws.com/select_car.png'; }} />}
                    </div>
